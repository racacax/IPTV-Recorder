    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recording_method', models.CharField(choices=[('auto', 'Auto'), ('wget', 'wget'), ('ffmpeg', 'ffmpeg')], max_length=64)),
            ],
        ),
        migrations.AddField(
            model_name='playlist',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_retry', models.DateTimeField(default=datetime.datetime(1970, 1, 1, 0, 0))),
                ('consecutive_retries', models.IntegerField(default=0)),
                ('total_retries', models.IntegerField(default=0)),
                ('selected_source', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='record.videosource')),
                ('sources', models.ManyToManyField(related_name='sources', to='record.videosource')),
            ],
        ),
    ]
